...
{
	public class NetworkPrimitiveTypesCodeGenerator : CodeGenerator
	{
		public NetworkPrimitiveTypesCodeGenerator()
		{
			Title = "Sync primitive value struct";
			...
			// Target Code Path
			CodeFilePath = $@"\KaNet\Synchronizers\NetworkTypes\NetworkPrimitiveTypes.cs";

			// Option Pathy
			CodeTemplatePath = $@"\NetworkPrimitiveTypesTemplate.txt";
			OptionFilePath = $@"\NetworkPrimitiveTypesOption.txt";
		}
